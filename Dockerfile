...
RUN apt-get clean && apt-get update && apt-get install --no-install-recommends -y git curl wget build-essential omniidl libomniorb4-dev libcos4-dev libomnithread4-dev libzmq3-dev python3 cmake build-essential libjpeg-dev
